# Liquidity 020: N day mean on illiquidity1_hl_mean
#
...
class YaoLqd020():
    ...
    def compute(self):
        ...
        stocks['alpha'] = stocks.groupby('code').illiquidity1_hl_mean.apply(lambda x: x.rolling(self.__window, min_periods=self.__window, closed='left').mean())
