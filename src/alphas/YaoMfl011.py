# Moneyflow 011:  N day mean, intraday outflow return, on mid orders
# Here outflow is based on price trajectory
# why inflow and outflow similar PnL results? did not split inflow or outflow correctly?
...
class YaoMfl011():
    ...
    def compute(self):
        ...
        stocks['alpha'] = stocks.groupby('code')['mid_outflow_ret'].apply(
            lambda x: x.rolling(self.__window, min_periods=self.__window, closed='left').mean())
