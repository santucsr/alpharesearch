# Moneyflow 014: mid net flow (inflow - outflow) / market cap, the compute N day mean
...
class YaoMfl014():
    ...
    def compute(self):
        ...
        mflows = dataloader.loading(tab_name="MoneyFlow2", start=self.__start, end=self.__end, fields=['code', 'mid_outflow_trv', 'mid_inflow_trv'])
        ...
        stocks['netflow'] = stocks.mid_inflow_trv - stocks.mid_outflow_trv
