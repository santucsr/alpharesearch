# Momentum 002: price MA cross over, (M day MA - N day MA) / N day MA, M < N
...
class YaoMoM002():
    ...
    def __compute_ppo(self, x):
        ...
        short = x.rolling(self.__shortTerm, min_periods=self.__shortTerm, closed='left').mean()
