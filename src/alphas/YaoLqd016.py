# Liquidity 016: Bollinger z score on open turnover - close turnover, -(Turnover - MA) / sigma
#
...
class YaoLqd016():
    ...
    def compute(self):
        ...
        stocks['trv_diff'] = stocks.am_open_trv - stocks.pm_close_trv
