# Moneyflow 010: - N day mean, intraday inflow return, on large orders
# here inflow is based on price trajectory
...
class YaoMfl010():
    ...
    def compute(self):
        ...
        stocks['alpha'] = -stocks.groupby('code').large_inflow_ret.apply(
