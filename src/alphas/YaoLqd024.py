# Reversion 024: turnover adjusted abosulte return, illiquidity ratio
# |R| / turnover
# here we first compute adjusted absoulte return, then calculate multiday means
...
class YaoLqd024():
    ...
    def __compute_var(self, x):
        ...
        ret = ret  / x.total_turnover.shift(1)
        return -ret.rolling(self.__window).mean()
