# Moneyflow 012: large net flow (inflow - outflow) turnover z score
...
class YaoMfl012():
    ...
    def compute(self):
        ...
        mflows = dataloader.loading(tab_name="MoneyFlow", start=self.__start, end=self.__end, fields=['code', 'large_outflow_trv', 'large_inflow_trv'])
        ...
        stocks['alpha'] = stocks.groupby('code').netflow.apply(self.__compute_bb)
