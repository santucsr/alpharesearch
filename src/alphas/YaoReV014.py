# Reversion 014: residual return reversion wiht market, smb and intrady std
# r* = r - beta1*r_m - beta2*r_smb - beta3*r_std - const
...
class YaoReV014():
    ...
    def __compute_rolling_capm(self, x):
        endog = x.ret_1d
        exog = sm.add_constant(x[['mkt_ret_1d', 'smb_ret_1d', 'ret_std']])
    ...
    def compute(self):
        ...
        stocks = self.__prepare_std(stocks)
