# Liquidity 010: intraday turnover std
# liquidity = intraday turnover / total turnover
# signal =  Bollinger z score, -(liquidity - MA) / sigma
#
...
class YaoLqd010():
    ...
    def compute(self):
        ...
        stocks['liquidity'] = stocks['turnover_std'] / stocks['total_turnover']
        ...
        stocks['alpha'] = stocks.groupby(
            'code').liquidity.apply(self.__compute_bb)
