# Moneyflow 016: mega net flow (inflow - outflow) / market cap, the compute N day mean
...
class YaoMfl016():
    ...
    def compute(self):
        ...
        mflows = dataloader.loading(tab_name="MoneyFlow2", start=self.__start, end=self.__end, fields=[
                                    'code', 'mega_outflow_trv', 'mega_inflow_trv'])
        ...
        stocks['netflow'] = stocks.mega_inflow_trv - stocks.mega_outflow_trv
