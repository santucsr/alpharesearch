# Liquidity 022: Bollinger z score on illiquidity1_hl_std, (illiquidity1_hl_std - MA) / sigma
#
...
class YaoLqd022():
    ...
    def compute(self):
        ...
        stocks['alpha'] = stocks.groupby('code').illiquidity1_hl_std.apply(self.__compute_bb)
