# Moneyflow 017: - N day mean, intraday return, on mega orders
...
class YaoMfl017():
    ...
    def compute(self):
        ...
        mflows = dataloader.loading(tab_name="MoneyFlow", start=self.__start, end=self.__end, fields=[
                                    'code', 'mega_ret'])
        ...
        stocks['alpha'] = -stocks.groupby('code')['mega_ret'].apply(
