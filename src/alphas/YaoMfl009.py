# Moneyflow 009: - N day mean, intraday inflow return, on mega orders
...
class YaoMfl009():
    ...
    def compute(self):
        ...
        stocks['alpha'] = -stocks.groupby('code').mega_inflow_ret.apply(lambda x: x.rolling(self.__window, min_periods=self.__window, closed='left').mean())
