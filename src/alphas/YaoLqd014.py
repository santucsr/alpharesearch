# Liquidity 014: liquidity = close - open
...
class YaoLqd014():
    ...
    def __compute_liquidity(self, x):
        return (x['pm_close_trv'] - x['am_open_trv']).rolling(self.__window, min_periods=self.__window, closed='left').mean()
