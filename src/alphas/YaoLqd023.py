# Liquidity 023: N day mean on illiquidity1_hl_std adjusted by market cap
#
...
class YaoLqd023():
    ...
    def compute(self):
        ...
        stocks['illiquidity1_hl_std_adj'] = stocks['illiquidity1_hl_std'] * stocks['neg_mkt_val']

        stocks['alpha'] = stocks.groupby('code').illiquidity1_hl_std_adj.apply(lambda x: x.rolling(self.__window, min_periods=self.__window, closed='left').mean())
