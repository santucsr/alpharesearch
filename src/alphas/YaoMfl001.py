# Moneyflow 001: mega inflow turnover ratio, inflow is defined as close > open
# mean(mege inflow turnover / total turnover, N);
...
class YaoMfl001():
    ...
    def compute(self):
        ...
        mflows = dataloader.loading(tab_name="MoneyFlow", start=self.__start, end=self.__end, fields=['code', 'mega_inflow_trv'])
