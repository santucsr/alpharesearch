# Technical 010: double exponential moving average revisit
# DEMA = 2 * EMA1 - EMA2, where EMA1 is N-day EMA and EMA2 is N-day EMA of EMA1
# signal = DEMA / close price
...
class YaoTec010():
    ...
    def compute(self):
        ...
        stocks['alpha'] = stocks.groupby(
            'code').adj_close.apply(self.__compute_DEMA)
