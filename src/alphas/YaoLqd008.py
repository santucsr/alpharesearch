# Liquidity 008: liquidity =  volume / market share
# mean(liquidity, N)
...
class YaoLqd008():
    ...
    def __compute_liquidity(self, x):
        ...
        return -(x['total_volume'] / x['neg_shares']).rolling(self.__window, min_periods=self.__window, closed='left').mean()
