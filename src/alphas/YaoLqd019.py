# Liquidity 001: Bollinger z score on illiquidity1_hl_mean, (illiquidity1_hl_mean - MA) / sigma
#
...
class YaoLqd019():
    ...
    def compute(self):
        ...
        stocks['alpha'] = stocks.groupby('code').illiquidity1_hl_mean.apply(self.__compute_bb)
