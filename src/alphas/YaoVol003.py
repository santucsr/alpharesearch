# Volatility 003: std on volumne adjusted return
...
class YaoVol003():
    ...
    def __compute_std(self, x):
        '''function to compute std on volumne adjusted return'''
        ...
        return -ret.rolling(self.__window).std()
    ...
    def compute(self):
        ...
        alpha = stocks.groupby('code').apply(
            self.__compute_std).reset_index().rename(columns={0: 'alpha'})
