# Volatility 012: N day high price return standard deviation., low volatility anomaly
...
class YaoVol012():
    ...
    def __compute_std(self, x):
        ...
        return pd.Series(ret.rolling(self.__window).std())
    ...
    def compute(self):
        ...
        stocks = dataloader.loading(
            tab_name="PV Basics", start=self.__start, end=self.__end, fields=['code', 'close', 'high'])
        ...
        stocks['alpha'] = -stocks.groupby(
            'code').adj_high.apply(self.__compute_std)
